...
do
	...
	function page.new(library, title, icon)
		...
		local container = utility:Create("ScrollingFrame", {
			...
			BackgroundTransparency = 1,
			BorderSizePixel = 0,
			Position = UDim2.new(0, 600, 0, 150),
	...
	function library:SelectPage(page, toggle)
		...
		if toggle then
			...
			for i, section in pairs(page.sections) do
				local sectionParent = section.container.Parent
				if sectionParent:IsA("ImageLabel") then
					sectionParent.ImageTransparency = 0
				end
			end
...
function section:updateColorPicker(colorpicker, title, color)
		...
		utility:Tween(tab.Container.Canvas.Cursor, {Position = UDim2.new(sat, 0, 1 - brightness, 0)}, 0.5)
