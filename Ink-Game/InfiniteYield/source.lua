...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://https://raw.githubusercontent.com/yourscoper/Roblox-Scripts/refs/heads/main/Ink-Game/InfiniteYield/source.lua'))()")
	end
end)
...
vehicleflyspeed = 1
function sFLY(vfly)
	repeat wait() until Players.LocalPlayer and Players.LocalPlayer.Character and getRoot(Players.LocalPlayer.Character) and (workspace.Camera:FindFirstChildOfClass("Humanoid") or Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid"))
	...
	local function FLY()
		...
		task.spawn(function()
			repeat wait()
				if not vfly and workspace.Camera:FindFirstChildOfClass("Humanoid") then
					workspace.Camera:FindFirstChildOfClass("Humanoid").PlatformStand = true
				elseif not vfly and Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid') then
			...
			BG:Destroy()
			BV:Destroy()
			if workspace.Camera:FindFirstChildOfClass("Humanoid") then
				workspace.Camera:FindFirstChildOfClass("Humanoid").PlatformStand = false
			elseif Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid') then
